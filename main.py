...
def main(source, destination):
    ...
    source_for_md = LeetcodeMaker(text[0], text[1], text[3:])
...
if __name__ == '__main__':
    main(r"C:\Users\Валентина\PycharmProjects\leetcode\source_leetcode_data.txt", r"C:\Users\Валентина\PycharmProjects\leetcode\math.md")
